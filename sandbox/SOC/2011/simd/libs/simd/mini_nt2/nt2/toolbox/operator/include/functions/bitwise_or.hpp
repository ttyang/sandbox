#ifndef NT2_TOOLBOX_OPERATOR_INCLUDE_FUNCTIONS_BITWISE_OR_HPP_INCLUDED
#define NT2_TOOLBOX_OPERATOR_INCLUDE_FUNCTIONS_BITWISE_OR_HPP_INCLUDED

#include <nt2/toolbox/operator/functions/bitwise_or.hpp>
