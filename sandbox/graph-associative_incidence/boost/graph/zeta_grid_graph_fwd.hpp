...
#ifndef BOOST_GRAPH_ZETA_GRID_GRAPH_FWD_HPP
...
namespace boost {
    ...
    template <BOOST_GRAPH_ZETA_GRID_TEMPLATE_PARAMS>
    typename edge_key_trait<BOOST_GRAPH_ZETA_GRID_TYPE>::type
        edge_key(
    ...
    template <BOOST_GRAPH_ZETA_GRID_TEMPLATE_PARAMS>
    BOOST_GRAPH_ZETA_GRID_TRAITS_MEM(vertices_size_type) const&
    ...
    template <BOOST_GRAPH_ZETA_GRID_TEMPLATE_PARAMS>
    BOOST_GRAPH_ZETA_GRID_TRAITS_MEM(edges_size_type) const&
...
#endif  // BOOST_GRAPH_ZETA_GRID_GRAPH_FWD_HPP
